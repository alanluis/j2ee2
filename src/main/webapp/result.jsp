...
<%@ page import="com.example.*,java.util.*" contentType="text/html; charset=UTF-8"%>
      ...
      <section>
        <div class="container">
            ...
            <menu><jsp:include page="menu.jsp">
                <jsp:param name="subtitle" value="Teste de parametro no include via page"/>
            </jsp:include></menu>
            ...
            <hr/>
            <h1>Application Servlet Context attribute by ServletContextListener</h1>
            ...
            <h2>Busca atributo no web.xml e anula o jspInit() do JSP para recuperar o valor</h2>
            <%!
            ...
            %>
            Scriptlet: <%= this.servletJSPEmail %><br>
            EL buscando Servlet init parameter através do pageContext: ${pageContext.getServletConfig().getInitParameter("servletJSPEmail")}<br>

            <hr/>
            <h1>Atributos em JSP (buscando através dos quatro objetos implicitos)</h1>
            ...
            <li>Session: <%= session.getAttribute("dogSession") %> </li>
            ...
            <jsp:useBean id="dogRequest" class="com.example.listener.Dog" scope="request" />
            ...
            <%! int count=0; %> <%-- deve ser uma variavel da classe, não dentro do service (ou seja não pode ser na tread, pois é unica para cada requisição --%> 
            <%= ++this.count %>

            <hr/>
            <h1>Criando objeto Employeee subclasse de Person</h1>
            <jsp:useBean id="person" type="com.example.Person" class="com.example.Employee" scope="page">
            ...
            <jsp:useBean id="person2" type="com.example.Person" class="com.example.Employee" scope="page">
                <jsp:setProperty name="person2" property="*"/>
            </jsp:useBean>
            Name: <jsp:getProperty name="person2" property="name" /><br>
            ID: <jsp:getProperty name="person2" property="empID" />


            <hr/>
            <h1>Buscar valor de subobjeto com a EL</h1>
            ${employeeWithDog.dog.breed}<br><br>
            ...
            <c:set var="employeeDog" scope="session" value="${employeeWithDog.dog}"/>

            <hr/>
            <h1>JSTL c:set com target beans e maps</h1>
            <c:set target="${employeeWithDog.dog}" property="breed" value="Raça do cachorro setado com set target"/>
            ...
            <h1>JSTL c:import</h1>
            <textarea>
                <c:import url="https://samples.openweathermap.org/data/2.5/forecast?id=524901&appid=b1b15e88fa797225412429c1c50c122a1"/>
            </textarea>
            ...
            <hr/>
            <a href="<% out.print(response.encodeURL("/BeerExpert/form.html")); %>">Back</a><br>
            Reescrita com c:url <a href="<c:url value='/form.html'/>">Back</a><br>
            Reescrita com c:url e codificação de valores 
            <a href="<c:url value='/form.html'><c:param name='firstName' value='First / name' /></c:url>">Back</a><br>
